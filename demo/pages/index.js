      ...
      <main className='h-full px-4 pt-4 max-w-[1400px] m-auto sm:px-8' >
        ...
        <div className='flex flex-col items-start flex-grow w-full min-h-screen'>
          ...
          <ul>
            ...
            <li>- <a className='link' href='https://github.com/nina-protocol/nina-indexer' target='_blank' rel="noopener noreferrer">nina-indexer</a> [an indexer for ingesting on-chain data from the Nina Program - used by the public Nina API] (<a className='link' href='https://api.docs.ninaprotocol.com'>Docs</a>)</li>
            <li>- <a className='link' href='https://github.com/nina-protocol/js-sdk' target='_blank' rel="noopener noreferrer">js-sdk</a> [Javascript SDK for fetching data from the Nina API] (<a className="link" href="http://sdk.docs.ninaprotocol.com">Docs</a>)</li>
          </ul>
        </div>
